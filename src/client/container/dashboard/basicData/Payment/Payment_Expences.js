...
import $ from "jquery";
import * as actionCreator from "../../../../actions/Basic_Data/Payment/Payment_Expences_action";

const Table = lazy(() => import("./Payment_Expences_Table"));

class Payment_Expences extends Component {
  constructor(props) {
    super(props);
      ...
      <Translation>
        {(t, { i18n }) => (
          <div>
            ...
            <div id="addExpences" className="modal fade" role="dialog">
...
const mapStateToProps = (state) => {
  return {
    ...
    member_data: state.r_Expences.member_data,
    payType_data: state.r_PayType.payType_data,
    tbl_state: state.r_Expences.state,
  };
};
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    add_Expences: (logedId, User_Id, reason, qty, value, state, token) => {
      dispatch(actionCreator.add_Expences(logedId, User_Id, reason, qty, value, state, token));
    },
  };
};

export default connect(mapStateToProps, mapDispatchToProps)(Payment_Expences);
