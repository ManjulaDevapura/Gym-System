...
import $ from "jquery";
import * as actionCreator from "../../../../actions/Basic_Data/Report/Report_Income_action";
...
this.props.fetch_Income(this.state.startDate, endDate, this.props.token)
                    }}>Search</button></td>
                    <td style={{width: 50}}><span> </span></td>
                    <td style={{width: 50}}><span> </span></td>
                    <td><button
...
const mapStateToProps = (state) => {
  return {
    ...
    expRep_data: state.r_RepIncome.expRep_data,
  };
};

const mapDispatchToProps = (dispatch) => {
  return {
    fetch_Income: (start, end, token) => {
      dispatch(actionCreator.fetch_Income(start, end, token));
    },
  };
};

export default connect(mapStateToProps, mapDispatchToProps)(Report_Income);
