...
import $ from "jquery";
import * as actionCreator from "../../../../actions/Basic_Data/Report/Report_Expences_action";

class Report_Expences extends Component {
  constructor(props) {
    super(props);
...
this.props.fetch_Expences(this.state.startDate, endDate, this.props.token)
                    }}>Search</button></td>
                    <td style={{width: 50}}><span> </span></td>
                    <td style={{width: 50}}><span> </span></td>
                    <td><button
                  ...
                  <div style={{}}>
                    ...
                    <div id={"divcontents"} style={{ paddingTop: 0 }}>
                      ...
                      >
                        ...
                        <tbody>
                          {this.props.expRep_data
                            ? this.props.expRep_data.map(
                                (repExp, index, array) => {
...
const mapStateToProps = (state) => {
  return {
    ...
    expRep_data: state.r_RepExpences.expRep_data,
  };
};

const mapDispatchToProps = (dispatch) => {
  return {
    fetch_Expences: (start, end, token) => {
      dispatch(actionCreator.fetch_Expences(start, end, token));
    },
  };
};

export default connect(mapStateToProps, mapDispatchToProps)(Report_Expences);
